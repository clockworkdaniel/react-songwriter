...
export default function UIControls(props) {
	...
	return (
		<div className="ui-controls">
			<button className="ui-controls__switch-button" 
				onClick={props.switchMode}
			>
				{props.chordMode ? "Lyrics Mode" : "Chord Mode" }
			</button>
			{props.chordMode && <div className="ui-controls__chord-input">
				<p>Chord:</p>
				<input value={props.chordToPaint} type="text" 
				onChange={handleChordChange}  
				/>
			</div>}
			{props.chordMode && <div className="ui-controls__specificity-select">
				<p>Assign chord by:</p>
				<select value={props.paintSpecificity} 
